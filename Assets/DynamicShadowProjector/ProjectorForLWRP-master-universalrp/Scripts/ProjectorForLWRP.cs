...
namespace ProjectorForLWRP
{
	...
	public class ProjectorForLWRP : ProjectorForSRP.ProjectorForSRP, ICustomRenderer
	{
		...
		internal event System.Action<UnityEngine.Camera> onAddProjectorToRenderer;
		protected override void AddProjectorToRenderer(UnityEngine.Camera camera)
		{
		...
		internal void WriteFrustumStencil(ScriptableRenderContext context, UnityEngine.Camera camera, Material nonSharedStencilMaterial)
		{
		...
		protected void WriteFrustumStencil(ScriptableRenderContext context, UnityEngine.Camera camera)
		{
