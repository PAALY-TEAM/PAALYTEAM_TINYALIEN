...
namespace ProjectorForSRP
{
    ...
    public abstract class ProjectorForSRP : MonoBehaviour
    {
        ...
        internal bool TryGetCullingResults(UnityEngine.Camera camera, out CullingResults cullingResults)
        {
        ...
        protected void GetDefaultDrawSettings(UnityEngine.Camera camera, Material material, out DrawingSettings drawingSettings, out FilteringSettings filteringSettings)
        {
        ...
        /// </summary>
        protected abstract void AddProjectorToRenderer(UnityEngine.Camera camera);
        ...
        protected virtual void OnEnable()
        {
            ...
            RenderPipelineManager.beginFrameRendering += (context, cameras1) => OnBeginFrameRendering(context, cameras1);
        }
        ...
        private Dictionary<UnityEngine.Camera, CullingResults> m_cullingResults;
        private void OnBeginFrameRendering(ScriptableRenderContext context, UnityEngine.Camera[] cameras)
        {
            ...
            {
                m_cullingResults = new Dictionary<UnityEngine.Camera, CullingResults>();
            }
        ...
        private bool StartCullingIfVisible(ScriptableRenderContext context, UnityEngine.Camera cam)
        {
