...
{ //Refactored script form https://catlikecoding.com/unity/tutorials/movement/
    public class PlayerMovementV02 : MonoBehaviour
    {
        [Header("Feedbacks")]
        ...
        // Add a serialized field for the Input Action Asset
        ...
        private void Update () {
            ...
            _playerInputVector3.x = inputVector.x;
            _playerInputVector3.z = inputVector.y;
            ...
            _playerInputVector3 = Vector3.ClampMagnitude(_playerInputVector3, 1f);
        ...
        private void AdjustVelocity () {
            ...
            adjustment.x =
                _playerInputVector3.x * speed - Vector3.Dot(relativeVelocity, xAxis);
            adjustment.z =
                _playerInputVector3.z * speed - Vector3.Dot(relativeVelocity, zAxis);
            adjustment =
